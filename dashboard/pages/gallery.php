...
<body>
    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-3 justify-content-center justify-content-around p-3">
      ...
      <div class="col">
        <div class="card shadow-sm border-0" id="card">
          <div id="imgp"><img src="../assets/accessories/1.png" class="card-img-top w-100 h-50" alt="..." id="img" /></div>
      ...
      <div class="col">
        <div class="card shadow-sm border-0" id="card">
          <div id="imgp1">
            <img src="../assets/accessories/4.png" class="card-img-top w-100 h-50" alt="..." id="img" />
          </div>
      ...
      <div class="col">
        <div class="card shadow-sm border-0" id="card">
          <div id="imgp2">
            <img src="../assets/accessories/8.png" class="card-img-top w-100 h-50" alt="..." id="img" />
          </div>
      ...
      <div class="col">
        <div class="card shadow-sm border-0" id="card">
          <div id="imgp3">
            <img src="../assets/accessories/9.png" class="card-img-top w-100 h-50" alt="..." id="img" />
          </div>
      ...
      <div class="col">
        <div class="card shadow-sm border-0" id="card">
          <div id="imgp4">
            <img src="../assets/laptop/atlas-gaming-asus-rog-strix-g17-a-removebg-preview.png" class="card-img-top w-100 h-50" alt="..." id="img" />
          </div>
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
              <p class="card-text">Razer Powerup Bundle</p>
      ...
      <div class="col">
        <div class="card shadow-sm border-0" id="card">
          <div id="imgp5">
            <img src="../assets/laptop/atlas-gaming-msi-gp76-leopard-a-removebg-preview.png" class="card-img-top w-100 h-471px" alt="..." id="img" />
          </div>
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
              <p class="card-text">Razer Powerup Bundle</p>
      ...
      <div class="col">
        <div class="card shadow-sm border-0" id="card">
          <div id="imgp6">
            <img src="../assets/laptop/atlas-gaming-msi-pc-portable-gamer-gf66-katana-a-800x800-removebg-preview.png" class="card-img-top w-100 h-471px" alt="..." id="img" />
          </div>
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
              <p class="card-text">Razer Powerup Bundle</p>
      ...
      <div class="col">
        <div class="card shadow-sm border-0" id="card">
          <div id="imgp7">
            <img src="../assets/disktop/1 (1).png" class="card-img-top w-100 h-50" alt="..." id="img" />
          </div>
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
              <p class="card-text">Razer Powerup Bundle</p>
      ...
      <div class="col">
        <div class="card shadow-sm border-0" id="card">
          <div id="imgp8">
            <img src="../assets/disktop/3.png" class="card-img-top w-100 h-50" alt="..." id="img" />
          </div>
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
              <p class="card-text">Razer Powerup Bundle</p>
  ...
  <section class="footer justify-content-center  " style="background: linear-gradient(
      109.6deg,
      rgb(43, 1, 91) 40.4%,
      rgb(122, 2, 54) 100.2%
    )" id="FOOTER">
        ...
        <div class="col-md-4">
          <div class="">
            ...
            <p class="text-decoration-none" style="color: rgb(219, 219, 219)">
              <strong class="d-inline-block" style="color: #c0bfbf">Address &nbsp; &nbsp;:</strong>
              &nbsp; Youcode Safi , Avenue Zraktouni Safi, Morocco
            </p>
            <p class="text-decoration-none" style="color: rgb(219, 219, 219)">
              <strong class="d-inline-block" style="color: #adadad">Phone&nbsp; &nbsp;:</strong>
              &nbsp; 0670018116
            </p>
            <p class="text-decoration-none" style="color: rgb(219, 219, 219)">
              <strong class="d-inline-block" style="color: #c0bfbf">Working hours&nbsp; &nbsp; :</strong>&nbsp; 10:00 - 18:00, Mon - Sat
            </p>
          </div>
        </div>
        <div class="col-md-3">
          ...
          <ul class="card-footer list-unstyled">
            <li>
              <a class="text-decoration-none" style="color: rgb(219, 219, 219)" href="#">
        ...
        <div class="row justify-content-center">
          <div class="col-10 col-md-2 mb-4 mb-md-0">
            <div class="bg-image hover-overlay ripple shadow-1-strong rounded" data-ripple-color="light">
              <img src="./../assets/imgs/ imgbg (2).jpg" class="w-100 h-100" />
              <a href="#!">
                <div class="mask" style="background-color: rgba(251, 251, 251, 0.016);"></div>
              </a>
            </div>
          </div>
          <div class="col-10 col-md-2 mb-4 mb-md-0">
            <div class="bg-image hover-overlay ripple shadow-1-strong rounded" data-ripple-color="light">
              <img src="./../assets/imgs/ imgbg (1).jpg" class="w-100  h-100" />

            </div>
          </div>
          <div class="col-10 col-md-2 mb-4 mb-md-0">
            <div class="bg-image hover-overlay ripple shadow-1-strong rounded" data-ripple-color="light">
              <img src="./../assets/imgs/ imgbg (3).jpg" class="w-100  h-100" />

            </div>
          </div>
          <div class="col-10 col-md-2 mb-4 mb-md-0">
            <div class="bg-image hover-overlay ripple shadow-1-strong rounded" data-ripple-color="light">
              <img src="./../assets/imgs/img1.jpg" class="w-100  h-100" />
    ...
    <section class="mb-4 text-center ">
      <!-- Facebook -->
      <a class="btn btn-link btn-floating btn-lg text-dark m-1" href="#!" role="button" data-mdb-ripple-color="dark"><i class="fab fa-facebook-f" style="color: rgb(26, 25, 25);"></i></a>

      <!-- Twitter -->
      <a class="btn btn-link btn-floating btn-lg text-dark m-1" href="#!" role="button" data-mdb-ripple-color="dark"><i class="fab fa-twitter" style="color: rgb(26, 25, 25);"></i></a>

      <!-- Google -->
      <a class="btn btn-link btn-floating btn-lg text-dark m-1" href="#!" role="button" data-mdb-ripple-color="dark"><i class="fab fa-google " style="color: rgb(26, 25, 25);"></i></a>
    </section>
