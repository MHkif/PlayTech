        ...
        <div class="col">
          <div class="card border-0 text-center">
            ...
            <div class="card shadow rounded-4">
              <img
                src="../../assets/imgs/gamming_acces.jpg"
                class="card-img p-4"
                alt="..."
              />
            </div>
        ...
        <div class="col-4">
          <div class="card p-3">
            <div class="row g-1">
              <div class="col-md-5">
                <img
                  src="../../assets/imgs/ps5-ds-removebg-preview.png"
...
<!--  -->
        ...
        <article class="postcard light red">
          <a class="postcard__img_link" href="#">
            <img
              class="postcard__img"
              src="../../assets/imgs/ac-sl1500-removebg-preview.png"
              alt="Image Title"
            />
          </a>
          <div class="postcard__text t-dark">
        ...
        <article class="postcard light green">
          <a class="postcard__img_link" href="#">
            <img
              class="postcard__img"
              src="../../assets/imgs/ps1-removebg-preview.png"
              alt="Image Title"
            />
          </a>
          <div class="postcard__text t-dark">
